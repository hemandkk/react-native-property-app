    ...
    <SafeAreaView className="flex-1 bg-white mb-10">
      <View className="items-center py-8">
        <View className="relative">
          ...
          />
          <TouchableOpacity
            className="absolute bottom-3 right-0 bg-gray-600 rounded-full p-2"
            disabled={isUpdating}
      ...
      <View className="px-6 gap-2">
        ...
        <MenuItem
          ...
          onPress={() =>
            Linking.openURL(
              "mailto:hemandkk@gmail.com?subject=Help%20%26%20Support%20-%20Kribb%20App",
            )
          }
        />
      </View>
      <View className=" px-6 mt-auto mb-8">
        <TouchableOpacity
          ...
          className="flex-row justify-center  items-center gap-2 bg-red-50 py-4  rounded-2xl border border-red-100"
        >
